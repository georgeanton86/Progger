...
export const sampleLabReviews: PatientLabReview[] = [
  {
    ...
    protocol: "HCG 5,000 IU SC 2x/wk · Enclomiphene 50mg PO 3x/wk · Post-Testosterone Cypionate",
    providerName: "Dr. George Antonopoulos, MD",
    summary: "Quest Diagnostics — 5/7/2026. Post-TRT fertility recovery protocol. Testosterone solid at 527 ng/dL — HCG is working. Key finding: SHBG elevated at 54 (flagged HIGH), binding testosterone and reducing free T bioavailability. Estradiol immunoassay shows <30 but this test is unreliable for males on HCG — ultrasensitive LC/MS/MS assay required for accurate reading. FSH/LH low-normal, pituitary still recovering. CBC and full metabolic panel entirely clean. Blood type O Negative confirmed.",
    categories: [
      {
        name: "Hormone Panel",
        icon: "⚗️",
        results: [
          { name: "Total Testosterone", value: 527, unit: "ng/dL", refRange: "250–827", status: "normal", note: "Solid. HCG is effectively maintaining testosterone production. Target 600–800 for optimal fertility." },
          { name: "SHBG", value: 54, unit: "nmol/L", refRange: "10–50", status: "high", note: "Elevated — binding more testosterone and reducing free T bioavailability. Address with Boron 10mg/day and insulin optimization." },
          { name: "Estradiol (E2)", value: "<30", unit: "pg/mL", refRange: "≤39 (immunoassay)", status: "borderline-low", note: "WARNING: Standard immunoassay is unreliable for males on HCG. Order Quest code 30289 (Ultrasensitive LC/MS/MS) for accurate male E2." },
          { name: "FSH", value: 3.6, unit: "mIU/mL", refRange: "1.4–12.8", status: "borderline-low", note: "Low-normal. FSH drives sperm production — enclomiphene should raise this over next 6–8 weeks. Goal >5." },
          { name: "LH", value: 3.8, unit: "mIU/mL", refRange: "1.5–9.3", status: "borderline-low", note: "Low-normal. Pituitary recovering from TRT suppression. HCG provides pseudo-LH support in the meantime." },
          { name: "Prolactin", value: 5.8, unit: "ng/mL", refRange: "2.0–18.0", status: "optimal", note: "Excellent. Elevated prolactin suppresses fertility — you're clear on this one." },
        ],
      },
      {
        ...
        icon: "🩸",
        results: [
          { name: "Hematocrit", value: 46.4, unit: "%", refRange: "39.4–51.1", status: "normal", note: "Normal — no polycythemia despite prior testosterone use." },
          { name: "Hemoglobin", value: 15.6, unit: "g/dL", refRange: "13.5–17.1", status: "normal" },
          { name: "RBC", value: 5.12, unit: "M/uL", refRange: "4.20–5.80", status: "normal" },
          { name: "WBC", value: 6.1, unit: "K/uL", refRange: "3.8–10.8", status: "optimal" },
          { name: "Platelets", value: 190, unit: "K/uL", refRange: "140–400", status: "normal" },
          { name: "MCV", value: 90.6, unit: "fL", refRange: "81.4–101.7", status: "optimal" },
        ],
      },
      {
        ...
        icon: "⚡",
        results: [
          { name: "Glucose", value: 87, unit: "mg/dL", refRange: "65–99", status: "optimal" },
          { name: "eGFR", value: 99, unit: "mL/min/1.73m2", refRange: ">60", status: "optimal", note: "Excellent kidney function." },
          { name: "BUN", value: 21, unit: "mg/dL", refRange: "7–25", status: "normal" },
          { name: "AST", value: 24, unit: "U/L", refRange: "10–40", status: "optimal", note: "Liver clear — no hepatotoxicity from prior androgen use." },
          { name: "ALT", value: 24, unit: "U/L", refRange: "9–46", status: "optimal" },
          { name: "ALP", value: 63, unit: "U/L", refRange: "36–130", status: "optimal" },
          { name: "Sodium", value: 140, unit: "mmol/L", refRange: "135–146", status: "optimal" },
          { name: "Potassium", value: 4.4, unit: "mmol/L", refRange: "3.5–5.6", status: "optimal" },
          { name: "Albumin", value: 4.6, unit: "g/dL", refRange: "3.6–5.1", status: "optimal" },
          { name: "Bilirubin", value: 0.3, unit: "mg/dL", refRange: "0.2–1.2", status: "optimal" },
        ],
      },
    ],
    recommendations: [
      "Order Estradiol Ultrasensitive LC/MS/MS — Quest code 30289 (immunoassay is NOT reliable for males on HCG)",
      "Address elevated SHBG (54 H): Boron 10mg daily with food — clinically reduces SHBG and raises free T",
      "Continue HCG 5,000 IU SC twice weekly — testosterone at 527 confirms it's working",
      "Continue Enclomiphene 50mg PO 3x weekly — FSH/LH recovering, give 8 more weeks",
      "Semen analysis in 90 days to assess active spermatogenesis response",
      "Blood type O Negative confirmed and on file",
    ],
    followUp: "Recheck: Total T, Free T, Estradiol (ultrasensitive), SHBG, FSH, LH in 8–10 weeks. Semen analysis at 12 weeks. Goal: SHBG <45, FSH >5. Add anastrozole only if ultrasensitive E2 returns >60 pg/mL.",
  },
];
